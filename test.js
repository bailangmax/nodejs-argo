...
const UUID = process.env.UUID || '82ca0bf2-4632-4ff3-8e36-a75e514d6d96'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.july.kdns.fr:10063';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'IWV1jk7lUMOldX2F7cY5PvBBtLWYwxXa';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
...
const CHAT_ID = process.env.CHAT_ID || '7627328147';                  // Telegram chat_id  两个变量不全不推送节点到TG 
const BOT_TOKEN = process.env.BOT_TOKEN || '8712829238:AAEkSunL7neEXazQUzTXFaWFbajD2SQEA-Y';              // Telegram bot_token 两个变量不全不推送节点到TG 
